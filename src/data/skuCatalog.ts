...
export const MASTER_ABD_SKU_LIST: ABDSkuItem[] = [
  ...
  { sku: 'FUNSP', tipeABD: 'FUN SP', model: 'BTE', aliasTipe: 'Signia Fun', aliasModel: 'SP', aliases: ['FUN SP', 'Fun SP', 'Signia Fun SP', 'signia fun sp', 'Signia Fun', 'signia fun', 'FUN SP BTE'], harga: 6000000 },
  { sku: 'FASTP', tipeABD: 'FAST P', model: 'BTE', aliasTipe: 'Signia Fast', aliasModel: 'P', aliases: ['FAST P', 'Fast P', 'Signia Fast P', 'signia fast P', 'Signia Fast', 'signia fast', 'FAST P BTE', 'Signia Fast P BTE'], harga: 4000000 },
